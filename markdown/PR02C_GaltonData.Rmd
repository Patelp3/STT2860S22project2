...
Yes, the new scatterplot seems to have a better correlation between the midparent height and the children height.
...
We made these choices to enhance the visual appearance of the plots, and to make the analysis phase of the experiment easier to conduct.
...
Fixing the ration of length between the y and x axes is important to preserve the relationship between the data. Otherwise the difference of units would violate this relationship.
