...
services_barplot <- 
  ...
  geom_bar() +
  theme_minimal() + 
  scale_fill_manual(values = c("#061ED8",  "#07D806", "#D80C06", "#06C4D8")) +
...
```{r}
  ggplot(streamingcontent_longer, 
         aes(x = Year, y = Service, color = Service)) +
  geom_boxplot() +
  theme_minimal() + 
  scale_color_manual(values = c("#061ED8",  "#07D806", "#D80C06", "#06C4D8")) +
...
I would have liked to have been able to explore the different genres for both of the datasets. It would have been nice to transform dataset 1 to be able to analyze the genres they offer and to have the genres for dataset 2 and observe what genres are more prominent on what streaming service. 
